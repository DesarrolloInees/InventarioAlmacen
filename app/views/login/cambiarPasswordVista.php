        ...
        <form action="<?php echo BASE_URL; ?>procesarCambioPassword" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <div class="relative mt-1">
                    ...
                    <i id="toggleNueva"
                        class="fa-solid fa-eye absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 cursor-pointer"></i>
                </div>
            </div>
            ...
            <button type="submit" id="submit-button" disabled class="w-full py-2 px-4 bg-indigo-600 text-white font-semibold rounded-lg shadow-md
