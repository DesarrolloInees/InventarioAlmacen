    ...
    <style>
        * {
        ...
        body {
            ...
            overflow: hidden;
            background: #0f172a;
            /* Color base de respaldo */
        }

        /* ✨ NUEVO FONDO ANIMADO: Tonos azulados y verdes para inventario ✨ */
        .animated-bg {
            position: fixed;
            width: 100%;
            height: 100%;
        ...
        .card-login {
            ...
            /* Fondo más oscuro y corporativo */
            backdrop-filter: blur(20px);
            -webkit-backdrop-filter: blur(20px);
            border: 1px solid rgba(56, 239, 125, 0.3);
            /* Borde con el verde del inventario */
            box-shadow:
        ...
        /* ✨ INPUTS CON EFECTOS PREMIUM (Nuevos colores) ✨ */
        .input-wrapper {
            position: relative;
        }
        ...
        /* ✨ BOTÓN CON EFECTO WOW (Nuevos colores: azul profundo a verde) ✨ */
        .btn-login {
            position: relative;
        ...
        .btn-login:hover {
            ...
            box-shadow:
                0 15px 40px rgba(17, 153, 142, 0.5),
        ...
        /* ✨ LOGO CON EFECTO DE BRILLO (Nuevo color) ✨ */
        .logo-container {
            position: relative;
    ...
    <div class="card-login rounded-3xl p-10 w-full max-w-md mx-4 text-center">
        ...
        <?php if ($error_login): ?>
            <div id="error-message"
                class="error-message mt-5 text-red-300 px-4 py-3 rounded-xl text-sm font-semibold flex items-center justify-center">
        ...
        <div class="mt-8 pt-6 border-t border-white border-opacity-10">
            <p class="text-xs text-white text-opacity-60">
                ...
                Sistema seguro I-Stock &copy; <?php echo date('Y'); ?>
            </p>
        </div>
    </div>
