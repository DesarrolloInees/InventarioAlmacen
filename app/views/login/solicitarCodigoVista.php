...
<head>
    ...
    <title>Recuperar Contraseña - Solicitud Prosegur</title>
...
<body class="flex items-center justify-center min-h-screen">
    ...
    <div class="card-login rounded-3xl p-10 w-full max-w-md mx-4 text-center">
        ...
        <p class="text-blue-200 mb-8 text-sm font-light">
            Ingresa tu correo registrado en <span class="font-semibold text-gradient">Solicitud Inees</span> y te enviaremos un código de verificación.
        </p>

        <!-- Formulario -->
        <form class="space-y-5" action="<?= BASE_URL ?>solicitarCodigo" method="POST">
            ...
            <button type="submit"
                class="btn-login w-full text-white font-bold py-4 rounded-xl text-base tracking-wide relative flex items-center justify-center gap-2">
