    ...
    <div class="bg-white dark:bg-gray-800 p-6 sm:p-8 rounded-xl shadow-md border border-gray-100 dark:border-gray-700">
        <div class="mb-6 border-b border-gray-200 dark:border-gray-700 pb-4">
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-white">
                <i class="fas fa-plus-circle text-blue-600 dark:text-blue-500 mr-2"></i> Crear Nuevo Rol
            </h1>
        </div>
        ...
        <form action="<?= BASE_URL ?>tipoUsuarioCrear" method="POST" class="space-y-6">
            <div>
                <label for="nombreTipoUsuario"
                    class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">Nombre del Rol <span
                ...
                <div class="relative">
                    ...
                    <input type="text" id="nombreTipoUsuario" name="nombreTipoUsuario" required
                        ...
                        value="<?= htmlspecialchars($datosPrevios['nombreTipoUsuario'] ?? '') ?>"
