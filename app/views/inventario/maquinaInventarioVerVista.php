...
<style>
    ...
    #maquinaTable tbody tr {
        background-color: white !important;
    }

    #maquinaTable tbody tr:hover {
    ...
    .dark #maquinaTable tbody tr {
        background-color: #1f2937 !important;
        color: #d1d5db !important;
    }

    .dark #maquinaTable tbody tr:hover {
        background-color: #374151 !important;
    }
    ...
    <div
        ...
        <div
            ...
            <div class="mt-4 sm:mt-0 flex flex-wrap gap-2">
                ...
                <?php endif; ?>
                <?php if ($esAdmin): ?>
                    <a href="<?= BASE_URL ?>maquinaInventarioCrear"
                        ...
                        <?php foreach ($data['maquinas'] as $m): ?>
                            <tr class="transition-colors border-b dark:border-gray-700">
                                ...
                                <td class="py-4 px-4 font-bold text-gray-900 dark:text-white">
                                    ...
                                    <?= htmlspecialchars($m['numero_serie']) ?>
                                </td>
                                ...
                                <td class="py-4 px-4">
                                    <?php if ($m['nombre_bodega']): ?>
                                        <span class="font-semibold text-blue-600 dark:text-blue-400"><i
                                                class="fas fa-warehouse text-xs mr-1"></i>
                                            <?= htmlspecialchars($m['nombre_bodega']) ?></span>
                                    <?php else: ?>
                                ...
                                <td class="py-4 px-4 text-center">
                                    ...
                                    ?>
                                    <span
                                        class="px-2 py-1 text-[10px] font-bold rounded-full border uppercase tracking-wider <?= $colorCond ?>">
                                ...
                                <td class="py-4 px-4">
                                    <?php if (!empty($m['estado_remision'])): ?>
                                        <span
                                            class="block font-medium text-purple-600 dark:text-purple-400"><?= htmlspecialchars($m['estado_remision']) ?></span>
                                        <span class="text-[10px] text-gray-500 dark:text-gray-400 leading-tight">Flujo
                                            independiente<br>(Sin O.S.)</span>
                                    <?php else: ?>
                                    ...
                                    <td class="py-4 px-4 text-center whitespace-nowrap">
                                        <div class="flex justify-center items-center space-x-2">
                                            ...
                                            <a href="<?= BASE_URL ?>maquinaMovimiento/<?= htmlspecialchars($m['id_maquina']) ?>"
                                                class="p-2 w-8 h-8 flex items-center justify-center bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-500 rounded-full hover:bg-blue-200 border border-blue-200 dark:border-blue-800"
                                                title="Registrar Traslado/Salida">
                                                <i class="fas fa-exchange-alt text-xs"></i>
                                            </a>
                                            <a href="<?= BASE_URL ?>maquinaMovimientoVer"
                                                class="p-2 w-8 h-8 flex items-center justify-center bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-500 rounded-full hover:bg-orange-200 border border-orange-200 dark:border-orange-800"
                                                title="Ver Movimientos de Máquinas">
                                                <i class="fa-solid fa-podcast text-xs"></i>
                                            </a>
            ...
            <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Esta acción borrará la máquina
                            permanentemente. Si tiene historial de movimientos, podrían borrarse también (dependiendo de
                            la base de datos). ¿Continuar?</p>
                    </div>
                </div>
            </div>
            <div
